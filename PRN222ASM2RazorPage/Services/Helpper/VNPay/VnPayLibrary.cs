...
namespace Services.Helpper.VNPay
{
    public class VnPayLibrary
    {
        ...
        public VNPaymentResponse GetFullResponseData(Microsoft.AspNetCore.Http.IQueryCollection collection, string hashSecret)
        {
            ...
            // 🔹 If running locally, skip signature validation
#if DEBUG
    ...
    bool checkSignature = vnPay.ValidateSignature(vnpSecureHash, hashSecret);
            ...
            if (!checkSignature)
            {
                ...
                {
                    Success = false,
                    VnPayResponseCode = vnpResponseCode ?? "INVALID_HASH",
                    OrderDescription = orderInfo,
                    TransactionId = vnPayTranId ?? "N/A"
                };
            }
